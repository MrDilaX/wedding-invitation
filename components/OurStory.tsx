const milestones = [
  { year: "2019", title: "First Meeting", description: "A chance encounter at a mutual friend's art gallery opening in San Francisco. Chanaka spotted Ganguni across the room and somehow found the courage to introduce himself." },
  ...
  { year: "2024", title: "The Proposal", description: "Chanaka proposed at the Napa winery where they had their first weekend getaway — down on one knee between the vines at golden hour." },
];
