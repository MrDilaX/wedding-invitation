"use client";
const events = [
  { time:"4:00 PM", title:"The Ceremony", desc:"Exchange of vows", icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg> },
...
export default function EventDetails() {
  const googleUrl=`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent("Adam & Lorah's Wedding")}&dates=20260831T160000/20260831T230000&location=${encodeURIComponent("Beringer Vineyards")}`;
  const icsUrl=`data:text/calendar;charset=utf8,${encodeURIComponent("BEGIN:VCALENDAR\nVERSION:2.0\nBEGIN:VEVENT\nDTSTART:20260831T160000\nDTEND:20260831T230000\nSUMMARY:Adam & Lorah's Wedding\nLOCATION:Beringer Vineyards\nEND:VEVENT\nEND:VCALENDAR")}`;
    ...
    <section id="details" style={{ padding:"5rem 1.5rem", backgroundColor:"var(--bg)" }}>
      <div style={{ maxWidth:"40rem", margin:"0 auto" }}>
        <div className="section-reveal" style={{ textAlign:"center", marginBottom:"3.5rem" }}>
          ...
          <p style={{ fontFamily:"'Jost', sans-serif", fontSize:"0.78rem", color:"var(--text-muted)" }}>August 31, 2026 · Beringer Vineyards, Napa Valley</p>
        </div>
